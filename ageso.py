...
### SEXOS ###
  ...
  if numero_femenino + numero_masculino != total_trabajadores:
    popup(f"Error: la suma de los sexos es diferente al número total de trabajadores en {ruta_datos[3:]}")
  ...
  if sum(elementos_edades) != total_trabajadores:
    popup(f"Error: la suma de las edades es diferente al número total de trabajadores en {ruta_datos[3:]}")
  ...
  if sum(elementos_estados) != total_trabajadores:
    popup(f"Error: la suma de los estados civiles es diferente al número total de trabajadores en en {ruta_datos[3:]}")
  ...
  if sum(elementos_escolaridades) != total_trabajadores:
    popup(f"Error: la suma de las escolaridades es diferente al número total de trabajadores en {ruta_datos[3:]}")
  ...
  if sum(elementos_fumadores) != total_trabajadores:
    popup(f"Error: la suma de los fumadores es diferente al número total de trabajadores en {ruta_datos[3:]}")
  ...
  if sum(elementos_tomadores) != total_trabajadores:
    popup(f"Error: la suma de los tomadores es diferente al número total de trabajadores en {ruta_datos[3:]}")
  ...
  if sum(elementos_ejercicio) != total_trabajadores:
    popup(f"Error: la suma de los ejercicios es diferente al número total de trabajadores en {ruta_datos[3:]}")
  ...
  elementos_imc = [sum(1 for i in imc if 1 <= i <= 18), sum(1 for i in imc if 18 <= i < 25),
                   sum(1 for i in imc if 25 <= i < 30), sum(1 for i in imc if 30 <= i < 35),
                   sum(1 for i in imc if 35 <= i < 40), sum(1 for i in imc if i >= 40), sum(1 for i in imc if i == 0)]

  #Validación
  if sum(elementos_imc) != total_trabajadores:
    popup(f"Error: la suma de los imcs es diferente al número total de trabajadores en {ruta_datos[3:]}")
  ...
  if sum(elementos_accidentes) != total_trabajadores:
    popup(f"Error: la suma de los accidentes laborales es diferente al número total de trabajadores en {ruta_datos[3:]}")
